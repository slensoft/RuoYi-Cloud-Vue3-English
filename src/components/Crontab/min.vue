    ...
    <el-form>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :value="2">
                ...
                <el-input-number v-model='cycle02' :min="cycle01 + 1" :max="59" /> minute
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :value="3">
                From
                <el-input-number v-model='average01' :min="0" :max="58" /> minute start, execute every
                <el-input-number v-model='average02' :min="1" :max="59 - average01" /> minute
            </el-radio>
        </el-form-item>
